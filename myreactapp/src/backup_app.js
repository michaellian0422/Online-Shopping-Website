...
class Nav extends React.Component 
{
  ...
  click_phones(){
    this.setState({catagory:"Phones"}, () => {
      this.handleSubmit();
    });
  }
  click_tablets(){
    console.log("test")
    this.setState({catagory:"Tablets"}, () => {
      this.handleSubmit();
    });
  }
  click_laptops(){
    this.setState({catagory:"Laptops"}, () => {
      this.handleSubmit();
    });
  }
  ...
  render(){
    ...
    return(
      <div className="Nav">
          <a className="nav_phones" href="#" onClick={()=>this.click_phones()}>Phones</a>
          <a className="nav_tablets" href="#" onClick={()=>this.click_tablets()}>Tablets</a>
          <a className="nav_laptops" href="#" onClick={()=>this.click_laptops()}>Laptops</a>
            ...
            <input className="nav_keyword" type="text" id="search" name="search" value={this.state.keyword} onChange={this.updatekeyword}/>
            <input className="nav_submit" type="submit" name="submit" value="Submit" onClick={()=>this.handleSubmit()}></input>
          <a href="#" className="nav_login" onClick={this.props.nav_onClick}>Sign in</a>
      </div>
    );
    }
    else{
      return(
        ...
        <select className="nav_catagory" name="category" id="category" onChange={this.selectchange} value={this.state.catagory}>
            ...
            <input className="nav_keyword" type="text" id="search" name="search" onChange={this.updatekeyword}/>
            <input className="nav_submit" type="submit" name="submit" value="Submit" onClick={()=>this.handleSubmit()}></input>
            <a className="nav_cart" href="#" onClick={()=> this.props.cart_click()}>🛒 {this.props.totalprod} in Cart</a>
          <div className="nav_logout">Hello, {this.props.username} <br/><a href="#" onClick={this.props.logout}>(Logout)</a></div>
      </div>
      )
    }
  }
    ...
    if (this.state.purchase_success == 1){
      ...
      return(
        <div className="product_view">
          ...
          <div className="prodcut_name">{this.props.targetproduct.name}</div>
          <div className="prodcut_price">{this.props.targetproduct.price}</div>
          <div className="prodcut_manufacturer">{this.state.productinfo[0].manufacturer}</div>
          <div className="prodcut_desc">{this.state.productinfo[0].description}</div>
...
class Login extends React.Component 
{
  ...
  render()
  {
    ...
    <div id="loginbody">
    <div id="login_part">
    <div className="login_messag" id="login_message">{this.state.message}Login in here</div>
  ...
  render() {
    return(
      <div >
        ...
        (
        <div className="prod_preview_div" key={product._id}>
          
          <a href="#" className="prod_preview_link"><img className="prod_preview_img" onClick={() => this.props.imageClick(product._id, product.name, product.price, product.productImage)}className="prod_preview_image" src={product.productImage}/></a>
